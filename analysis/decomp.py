...
file_name = 'data/synthetic/400k_samples_txp_1551.5_pax_1556.5_polcon_and_fiber_2_1Hz.mat'
...
for var_name in variables:
    if var_name in mat_data:
        ...
        # save figure
        save_name = f'analysis/plots/decomposition_{var_name}.png'
...
for base in bases:
    ...
    fig_base_raw.savefig(f'analysis/plots/raw_data_{base}.png')
...
fig_season_color.savefig('analysis/plots/combined_seasonality.png')
...
fig_trend_color.savefig('analysis/plots/combined_trend.png')
